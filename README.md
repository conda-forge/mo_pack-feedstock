...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/mo_pack-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/mo_pack-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
It is possible to list all of the versions of `mo_pack` available on your platform:
...
```
pixi search mo_pack --channel conda-forge
```
